...
SECRET_KEY = 'django-insecure-4y%p@mu$c59^*$6wy==y7v0$k8lsasy9n6i^2tron4y9p3c_qx'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / "ex01" / "static"]
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'ex02', HISTORY_LOG),
            'formatter': 'verbose',
        },
    },
    'loggers': {
